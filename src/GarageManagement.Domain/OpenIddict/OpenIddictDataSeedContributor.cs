...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("GarageManagement") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "GarageManagement", DisplayName = "GarageManagement API", Resources = { "GarageManagement" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["GarageManagement_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["GarageManagement_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        List<string>? permissions = null)
    {
        ...
        {
            application.Permissions.Add(OpenIddictConstants.Permissions.Prefixes.Endpoint + "logout");
        }
        ...
        foreach (var grantType in grantTypes)
        {
            ...
            if (grantType == OpenIddictConstants.GrantTypes.DeviceCode)
            {
                ...
                application.Permissions.Add(OpenIddictConstants.Permissions.Prefixes.Endpoint + "device_authorization");
            }
