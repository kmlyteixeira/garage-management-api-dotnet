...
namespace GarageManagement.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260713230037_AddMissingEstimateItemForeignKeys")]
    partial class AddMissingEstimateItemForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GarageManagement.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageManagement.Estimates.Estimate", b =>
                {
                    ...
                    b.Property<Guid?>("ConvertedToServiceOrderId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageManagement.Estimates.EstimateServiceItem", b =>
                {
                    ...
                    b.HasIndex("EstimateId", "ServiceId");

                    b.ToTable("AppEstimateServiceItems", (string)null);
                });

            modelBuilder.Entity("GarageManagement.Inventories.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageManagement.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageManagement.Vehicles.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GarageManagement.Estimates.EstimateProductItem", b =>
                {
                    ...
                    b.HasOne("GarageManagement.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GarageManagement.Estimates.EstimateServiceItem", b =>
                {
                    ...
                    b.HasOne("GarageManagement.Services.Service", "Service")
                        .WithMany()
