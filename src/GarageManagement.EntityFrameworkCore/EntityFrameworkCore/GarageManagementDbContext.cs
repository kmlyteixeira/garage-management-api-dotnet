    ...
    ITenantManagementDbContext
{
    ...
    public GarageManagementDbContext(DbContextOptions<GarageManagementDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfigurationsFromAssembly(typeof(GarageManagementDbContext).Assembly);

        /* Configure your own tables/entities inside here */

        //builder.Entity<YourEntity>(b =>
        //{
        //    b.ToTable(GarageManagementConsts.DbTablePrefix + "YourEntities", GarageManagementConsts.DbSchema);
